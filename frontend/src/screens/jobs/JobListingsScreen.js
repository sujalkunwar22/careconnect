        ...
        <View className="flex-row items-center bg-white rounded-2xl px-4 py-3.5 border border-slate-100 shadow-md shadow-slate-200/50 mb-5">
          ...
          <TextInput
            ...
            onChangeText={setSearchQuery}
                    ...
                    />
          <TouchableOpacity className="p-2 bg-primary/10 rounded-xl">
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} className="flex-row mb-6">
          {categories.map((cat) => (
            <TouchableOpacity
              ...
              className={`mr-3 px-5 py-2.5 rounded-2xl border ${activeCategory === cat ? 'bg-primary border-primary shadow-md shadow-primary/30' : 'bg-white border-slate-100'}`}
            >
